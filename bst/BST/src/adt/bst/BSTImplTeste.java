...
public class BSTImplTeste {
	...
	public void testInsert() {
		...
		assertArrayEquals(new Integer[] { 8, 4, 2, 1, 3, 6, 5, 7, 12, 10, 9,
				11, 14, 13, 15 }, tree4.preOrder());
		assertArrayEquals(new Integer[] { 1, 3, 2, 5, 7, 6, 4, 9, 11, 10, 13,
				15, 14, 12, 8 }, tree4.postOrder());
	}
	...
	public void testPredecessor() {
		...
		node.setData(23);
		assertEquals(new Integer(22), tree4.predecessor(node.getData())
				.getData());

		node.setData(22);
		assertEquals(new Integer(18), tree4.predecessor(node.getData())
				.getData());

		node.setData(16);
		assertEquals(new Integer(15), tree4.predecessor(node.getData())
				.getData());

		node.setData(18);
		assertEquals(new Integer(16), tree4.predecessor(node.getData())
				.getData());
	...
	public void testPreOrder() {
		...
		assertArrayEquals(new Integer[] { 5, 3, 1, 4, 8, 6, 9 },
				tree3.preOrder());
	...
	public void testPostOrder() {
		...
		assertArrayEquals(new Integer[] { 1, 4, 3, 6, 9, 8, 5 },
				tree3.postOrder());
