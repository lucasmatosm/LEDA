...
/**
* Classe AVLTreeImpl, esta estrutura representa um arvore balanceada (AVL). 
* Essa estrutura extends de BST, so que como se trata de uma arvore balanceada 
* quando ela comeca a "pesar" para um dos lados, sao feitas sucessivas rotacoes
* afim de que a AVL se rebalaceie e a diferenca de altura entre os lados da AVL 
* nao seja maior que 1.
* 
...
public class AVLTreeImpl<K extends Comparable<? super K>, V> extends
	...
	/**
	 * Metodo da classe AVLTreeImpl, que retorna um inteiro que 
	 * eh a diferenca das alturas a esquerda e a direita de um no 
	 * passado como parametro, se essa altura for maior que 1, a arvore 
	 * esta desbalanceada.
	 * @param node
	 * 		no que deseja verificar a diferenca de altura.
	 * @return
	 * 		um inteiro que eh a diferenca de altura entre os lados do no
	 */
	// AUXILIARY
	...
	/**
	 * Metodo da classe AVLTreeImpl, que rebalanceia a arvore AVL 
	 * caso ela esteja desbalanceada.
	 * @param node
	 * 		no em que foi calculado o o balance e que apresentou desbalaceamento.
	 */
	// AUXILIARY
	...
	/**
	 * Metodo da classe AVLTreeImpl, que faz rotacoes 
	 * @param node
	 */
	// AUXILIARY
	...
	public void remove2(BSTNode<K, V> node){
		super.remove(node);
	}
}